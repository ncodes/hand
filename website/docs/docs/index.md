...
Hand is a terminal-first personal agent backed by a local daemon, durable sessions, memory, search, and optional messaging gateways.
...
- **Getting Started**: installation, first chat, profiles, and learning paths.
- **Concepts**: the mental model for daemon, RPC, sessions, memory, tools, and gateways.
