...
type VectorRecordLister interface {
	List(context.Context, VectorListRequest) (VectorListResult, error)
}
...
func ValidateVectorListRequest(req VectorListRequest) error {
	if strings.TrimSpace(req.EmbeddingModel) == "" {
