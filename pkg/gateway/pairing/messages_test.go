...
func TestChallengeMessage_RendersApprovalCommandWithoutSecrets(t *testing.T) {
	...
	require.Contains(t, message, "morph gateway pairing approve telegram 12345678")
...
func TestChallengeMessage_DefaultsBlankSourceToGateway(t *testing.T) {
	...
	require.Contains(t, message, "Pair this gateway chat with Morph")
	require.Contains(t, message, "morph gateway pairing approve gateway 12345678")
}
